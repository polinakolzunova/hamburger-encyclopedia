<?php require PROJECT_PATH . '/app/views/templates/header.php'; ?>
	...
	<section id="one-burger">
		<div class="image">
			<img src="img/burger0.jpg" alt="burger">
		</div>
		<h1>Название бургера 6</h1>
		<div class="description">
			<div class="info">
				<p>Страна: США</p>
				<p>Рейтинг: 4.4 / 5</p>
				<p>Ингридиенты: зерновая булочка, огурец, помидор, говяжья котлета, соус классический, листовой салат</p>
			</div>
			<div class="text">
